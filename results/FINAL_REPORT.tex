...
\texttt{tests/} & \texttt{pytest} suite (87 tests across 14 files). \\
\bottomrule
\end{tabular}
\end{table}
...
worker executing one independent simulation. Correctness is guarded by a \texttt{pytest} suite of 87
